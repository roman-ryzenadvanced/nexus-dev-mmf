...
interface ZAIClient {
  chat: {
    completions: {
      create: (body: Record<string, unknown>) => Promise<ZAIResponse>;
    };
  };
}
...
/** Public type alias for a ready ZAI client (used by the code-review, mtp, and design engines). */
export type ZAI = ZAIClient;
